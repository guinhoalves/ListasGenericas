...
//   OpcoesPage({required this.lista});
//   @override
...
//     TextEditingController _updatedNomeLista = TextEditingController(text: widget.lista.title);
...
//                   Text(
//                     "Tem certeza?",
//                     style: TextStyle(color: Colors.blueGrey.shade900, fontSize: 18.0),
//                   )
//                 ]),
//               ),
//             ],
...
//               ),
//               onPressed: () async {
//                 await helper.getAllItensLista(widget.lista.id).then((list) async {
...
//             child: ListBody(
//               children: <Widget>[
//                 Text('Esta Funcionalidade ainda esta em fase de desenvolvimento!'),
//               ],
//             ),
//           ),
//           actions: <Widget>[
